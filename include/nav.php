          ...
          <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
            ...
            <div class="offcanvas-body">
              <ul class="navbar-nav justify-content-end flex-grow-1 gap-1 gap-md-5 pe-3">
                <li class="nav-item">
                  <a class="nav-link  <?= ($page == "home.php" ? "active" : "") ?>" href="index.php?p=home"
                    aria-haspopup="true" aria-expanded="false">Home</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link <?= ($page == "shop.php" ? "active" : "") ?> " href="index.php?p=shop " aria-haspopup="true" aria-expanded="false">Shop</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link <?= ($page == "contact.php" ? "active" : "") ?> " href="index.php?p=contact " aria-haspopup="true" aria-expanded="false">Contact</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link <?= ($page == "about.php" ? "active" : "") ?> " href="index.php?p=about " aria-haspopup="true" aria-expanded="false">About Us</a>
                </li>
